    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div
                ...
                <div class="relative z-10 mt-2">
                    <p class="text-5xl font-black text-gray-900 tracking-tight"><?php echo e($totalPatients); ?>
            ...
            <div
                ...
                <div class="relative z-10 mt-2">
                    <p class="text-5xl font-black text-gray-900 tracking-tight"><?php echo e($totalDoctors); ?>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div
                ...
                <div>
                    <h4 class="text-2xl font-extrabold text-gray-900 leading-none">
                        <?php echo e($pendingAppointments); ?>
            ...
            <div
                ...
                <div>
                    <h4 class="text-2xl font-extrabold text-gray-900 leading-none">
                        <?php echo e($confirmedAppointments); ?>
            ...
            <div
                ...
                <div>
                    <h4 class="text-2xl font-extrabold text-gray-900 leading-none"><?php echo e($cancelledThisMonth); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase leading-none"><?php echo e(\Carbon\Carbon::parse($appt->date)->translatedFormat('M')); ?></span>
                                        <span
                                            class="text-xl font-bold text-gray-900 dark:text-white leading-tight mt-0.5"><?php echo e(\Carbon\Carbon::parse($appt->date)->format('d')); ?></span>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex justify-between items-start mb-1">
                                            <p class="font-bold text-gray-900 dark:text-white text-base truncate">
                                                <?php echo e($appt->patient->user->name); ?>

                                            </p>
                                            <span
                                                class="text-sm font-semibold text-gray-700 dark:text-gray-300 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($appt->date)->format('H:i')); ?></span>
                                        </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="relative">
                                        ...
                                        <span
                                            class="absolute -bottom-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold border-2 border-white dark:border-gray-800 transition-colors
                                                                                        <?php echo e($i === 0 ? 'bg-yellow-400 text-yellow-900' : ($i === 1 ? 'bg-gray-300 text-gray-800' : ($i === 2 ? 'bg-orange-300 text-orange-900' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'))); ?>">
                                            <?php echo e($i + 1); ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex justify-between items-center mb-1.5">
                                            ...
                                            <span
                                                class="text-sm font-semibold text-gray-700 dark:text-gray-300"><?php echo e($doctor->month_count); ?>
