<header
    ...
    <div>
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e($title ?? 'Dashboard'); ?></h1>
                 ...
                 <?php $__env->slot('trigger', null, []); ?> 
                    <button
                        ...
                        <div class="text-left hidden sm:block">
                            ...
                            <div class="text-[10px] text-gray-500 dark:text-gray-400"><?php echo e(Auth::user()->role_label); ?>
