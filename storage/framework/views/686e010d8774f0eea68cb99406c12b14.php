...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mis Citas <?php $__env->endSlot(); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div class="flex items-start gap-5 relative z-10">
                                ...
                                ?>
                                <div
                                    class="w-16 h-16 shrink-0 rounded-[1.25rem] <?php echo e($dateStyles); ?> border shadow-inner flex flex-col items-center justify-center group-hover:scale-105 transition-transform duration-300">
                                    <span
                                        class="text-2xl font-extrabold leading-none tracking-tight"><?php echo e(\Carbon\Carbon::parse($appt->date)->format('d')); ?></span>
                                    <span
                                        class="text-[11px] uppercase font-bold tracking-wider mt-0.5"><?php echo e(\Carbon\Carbon::parse($appt->date)->translatedFormat('M y')); ?></span>
                                </div>
                                <div class="pt-1">
                                    <div class="flex flex-wrap items-center gap-3 mb-1.5">
                                        <h3 class="font-bold text-gray-900 text-lg tracking-tight">Dr. <?php echo e($appt->doctor->user->name); ?></h3>
                                        <?php
                                        ...
                                        ?>
                                        <span
                                            class="px-2.5 py-1 rounded-lg text-[11px] font-bold bg-<?php echo e($c); ?>-50 text-<?php echo e($c); ?>-700 ring-1 ring-inset ring-<?php echo e($c); ?>-200/50">
                                    ...
                                    <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-[15px] font-medium text-gray-500">
                                        ...
                                        <span class="text-blue-600"><?php echo e($appt->specialty->name); ?></span>
                                    </div>
                            ...
                            <div class="flex items-center gap-3 w-full sm:w-auto mt-2 sm:mt-0 relative z-10">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($appt->status, ['pending', 'confirmed'])): ?>
                                    <button
                                ...
                                <div class="bg-white rounded-3xl max-w-md w-full shadow-2xl overflow-hidden transform transition-transform scale-100">
                                    <div class="p-8">
                                        ...
                                        <p class="text-[15px] text-gray-500 mb-6 leading-relaxed">
                                            ...
                                            <strong class="text-gray-900"><?php echo e(\Carbon\Carbon::parse($appt->date)->format('d/m/Y H:i')); ?></strong> con el
                                            <strong class="text-gray-900">Dr. <?php echo e($appt->doctor->user->name); ?></strong>. Esta acción no se puede deshacer.
                                        </p>

                                        <form method="POST" action="<?php echo e(route('portal.appointments.cancel', $appt)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <div class="mb-6">
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\portal\appointments.blade.php ENDPATH**/ ?>