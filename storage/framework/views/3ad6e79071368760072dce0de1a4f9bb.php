...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mensajes <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-4xl mx-auto space-y-6 pb-12">
        ...
        <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden min-h-[400px]">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($availableDoctors->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableDoctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <a href="<?php echo e(route('portal.chat.show', $doctor)); ?>" class="p-5 sm:p-6 hover:bg-gray-50 transition flex items-center justify-between gap-5 group relative">
                            <div class="flex items-center gap-4 w-full">
                                <div class="relative">
                                    <img src="<?php echo e($doctor->avatar_url); ?>" alt="Dr. <?php echo e($doctor->name); ?>" class="w-14 h-14 rounded-2xl object-cover shadow-sm border border-gray-200 group-hover:scale-105 transition-transform">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex justify-between items-baseline mb-1">
                                        <h3 class="font-bold text-gray-900 truncate pr-4">Dr. <?php echo e($doctor->name); ?></h3>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastMessage): ?>
                                            <span class="text-xs text-gray-400 font-medium shrink-0"><?php echo e($lastMessage->created_at->diffForHumans(null, true, true)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <p class="text-sm <?php echo e($unreadCount > 0 ? 'text-gray-900 font-semibold' : 'text-gray-500'); ?> truncate">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastMessage): ?>
                                            ...
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php echo e(Str::limit($lastMessage->content, 40)); ?>
...
<?php endif; ?>
<?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\portal\chat\index.blade.php ENDPATH**/ ?>