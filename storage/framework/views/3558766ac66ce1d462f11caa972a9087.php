...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Editar Registro Clínico <?php $__env->endSlot(); ?>

    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <div class="mb-6 pb-4 border-b border-gray-100">
                <p class="text-sm text-gray-500">
                    Paciente: <span class="font-semibold text-gray-900"><?php echo e($medicalRecord->patient->user->name); ?></span>
                    · Fecha original: <span class="font-mono text-gray-600"><?php echo e($medicalRecord->record_date->format('d/m/Y')); ?></span>
                </p>
            </div>

            <form method="POST" action="<?php echo e(route('medical-records.update', $medicalRecord)); ?>" class="space-y-6" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="doctor_id" required
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doc->id); ?>" <?php echo e(old('doctor_id', $medicalRecord->doctor_id) == $doc->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <input type="date" name="record_date" value="<?php echo e(old('record_date', $medicalRecord->record_date->format('Y-m-d'))); ?>" required
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select name="appointment_id"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($appt->id); ?>" <?php echo e(old('appointment_id', $medicalRecord->appointment_id) == $appt->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                        ...
                        <div>
                            ...
                            <input type="text" name="<?php echo e($vital['field']); ?>"
                                value="<?php echo e(old($vital['field'], $medicalRecord->{$vital['field']})); ?>"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="chief_complaint" rows="2" required
                                class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('chief_complaint', $medicalRecord->chief_complaint)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="diagnosis" rows="3" required
                                class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('diagnosis', $medicalRecord->diagnosis)); ?></textarea>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tratamiento</label>
                                <textarea name="treatment" rows="3"
                                    class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('treatment', $medicalRecord->treatment)); ?></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Notas Clínicas</label>
                                <textarea name="notes" rows="3"
                                    class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('notes', $medicalRecord->notes)); ?></textarea>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea name="prescriptions" rows="3"
                                    class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('prescriptions', $medicalRecord->prescriptions)); ?></textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Derivación</label>
                                <textarea name="referred_to" rows="3"
                                    class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('referred_to', $medicalRecord->referred_to)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($medicalRecord->attachments && $medicalRecord->attachments->count() > 0): ?>
                        <div class="mb-4 grid grid-cols-2 sm:grid-cols-4 gap-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $medicalRecord->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col p-2 bg-gray-50 border border-gray-100 rounded-lg group relative">
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <div class="truncate text-xs font-medium text-gray-700 flex-1" title="<?php echo e($attachment->file_name); ?>">
                                            <?php echo e($attachment->file_name); ?>

                                        </div>
                                    </div>
                                    <a href="<?php echo e(route('medical-records.attachments.destroy', $attachment)); ?>" 
                                       onclick="event.preventDefault(); document.getElementById('delete-file-<?php echo e($attachment->id); ?>').submit();"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_private" value="1" <?php echo e(old('is_private', $medicalRecord->is_private) ? 'checked' : ''); ?>
                ...
                <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
                    <a href="<?php echo e(route('medical-records.show', $medicalRecord)); ?>" class="px-5 py-2 text-sm text-gray-500 hover:text-gray-700">Cancelar</a>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($medicalRecord->attachments): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $medicalRecord->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form id="delete-file-<?php echo e($attachment->id); ?>" action="<?php echo e(route('medical-records.attachments.destroy', $attachment)); ?>" method="POST" class="hidden">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\medical-records\edit.blade.php ENDPATH**/ ?>