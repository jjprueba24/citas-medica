...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mi Portal Médico <?php $__env->endSlot(); ?>
        ...
        <div class="rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden relative group">
            ...
            <div
                ...
                <div class="max-w-2xl">
                    ...
                    <a href="<?php echo e(route('portal.appointments.create')); ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('portal.appointments')); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-start mb-5">
                                    <div class="flex items-center gap-4">
                                        <div
                                            ...
                                            <span
                                                class="text-xl font-extrabold leading-none tracking-tight"><?php echo e(\Carbon\Carbon::parse($appt->date)->format('d')); ?></span>
                                            <span
                                                class="text-[11px] font-bold uppercase tracking-wider text-blue-500 mt-0.5"><?php echo e(\Carbon\Carbon::parse($appt->date)->translatedFormat('M')); ?></span>
                                        </div>
                                        <div>
                                            <p class="text-[15px] font-bold text-gray-900 whitespace-nowrap mb-1">
                                                <?php echo e(\Carbon\Carbon::parse($appt->date)->format('H:i')); ?> hrs
                                            </p>
                                            <span
                                                class="px-2.5 py-1 rounded-lg text-[11px] font-bold ring-1 ring-inset <?php echo e($c); ?>">
                                ...
                                <div class="pt-4 border-t border-gray-50">
                                    <p class="font-bold text-gray-900 text-[15px] mb-0.5">Dr. <?php echo e($appt->doctor->user->name); ?>

                                    </p>
                                    <p class="text-sm font-medium text-blue-600 mb-2.5"><?php echo e($appt->specialty->name); ?></p>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appt->office): ?>
                                        <div class="flex items-center gap-1.5 text-sm text-gray-500">
                                            ...
                                            <span class="truncate font-medium"><?php echo e($appt->office->name); ?></span>
                                        </div>
            ...
            <div class="space-y-6">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('portal.medical-history')); ?>"
                ...
                <div
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($recentHistory->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="divide-y divide-gray-50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $recentHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('portal.medical-history')); ?>"
                                    ...
                                    <div class="flex justify-between items-start mb-2">
                                        <p
                                            ...
                                            <?php echo e($rec->diagnosis ?: 'Consulta de Seguimiento'); ?>

                                        </p>
                                        <span
                                            class="text-xs font-semibold text-gray-400 shrink-0 bg-gray-50 px-2 py-1 rounded-md"><?php echo e($rec->record_date->format('d/m/y')); ?></span>
                                    </div>
                                    <div class="flex items-center gap-2 mb-3">
                                        <div class="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
                                            <span
                                                class="text-[10px] font-bold text-blue-700"><?php echo e(substr($rec->doctor->user->name, 0, 1)); ?></span>
                                        </div>
                                        <p class="text-sm font-medium text-gray-600">Dr. <?php echo e($rec->doctor->user->name); ?></p>
                                    </div>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\portal\dashboard.blade.php ENDPATH**/ ?>