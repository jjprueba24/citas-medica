<aside class="w-20 lg:w-64 bg-[#4A88F6] text-white flex-shrink-0 min-h-screen hidden md:flex flex-col">
    <!-- Logo area -->
    ...
    <nav class="flex-1 py-6 space-y-1">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route($item['route'])); ?>"
                class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e($active ? 'text-white' : 'text-white/70 hover:text-white'); ?> transition">
    ...
    <div class="pb-6 space-y-1">
        ...
        <a href="<?php echo e(route('users.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('users.*') ? 'text-white' : 'text-white/70 hover:text-white'); ?> transition">
        ...
        <a href="<?php echo e(route('settings.backups.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.backups.*') ? 'text-white' : 'text-white/70 hover:text-white'); ?> transition">
        ...
        <a href="<?php echo e(route('settings.email_templates.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.email_templates.*') ? 'text-white' : 'text-white/70 hover:text-white'); ?> transition">
        ...
        <a href="<?php echo e(route('settings.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.index') ? 'text-white' : 'text-white/70 hover:text-white'); ?> transition">
