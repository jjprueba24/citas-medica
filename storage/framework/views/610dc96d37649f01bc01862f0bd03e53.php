...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Historia Clínica <?php $__env->endSlot(); ?>

    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <form method="GET" action="<?php echo e(route('medical-records.index')); ?>" class="flex gap-2 flex-wrap">
            <select name="patient_id"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($p->id); ?>" <?php echo e(request('patient_id') == $p->id ? 'selected' : ''); ?>><?php echo e($p->user->name); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->anyFilled(['patient_id', 'doctor_id'])): ?>
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900">
                            <a href="<?php echo e(route('medical-records.patient-history', $rec->patient)); ?>"
                                class="hover:text-blue-600">
                                <?php echo e($rec->patient->user->name); ?>

                            </a>
                        </td>
                        <td class="px-6 py-4 text-gray-600">Dr. <?php echo e($rec->doctor->user->name); ?></td>
                        <td class="px-6 py-4 text-gray-700 max-w-xs truncate"><?php echo e($rec->diagnosis); ?></td>
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <a href="<?php echo e(route('medical-records.edit', $rec)); ?>"
                                ...
                                <form method="POST" action="<?php echo e(route('medical-records.destroy', $rec)); ?>"
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\medical-records\index.blade.php ENDPATH**/ ?>