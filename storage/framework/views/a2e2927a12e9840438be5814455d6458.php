...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Historial Clínico — <?php echo e($patient->user->name); ?> <?php $__env->endSlot(); ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900"><?php echo e($patient->user->name); ?></h2>
                        <p class="text-sm text-gray-400"><?php echo e($patient->user->email); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($patient->dob): ?> · <?php echo e(\Carbon\Carbon::parse($patient->dob)->age); ?> años <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </p>
                    </div>
                </div>
                        ...
                        <div class="pl-16 relative">
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition">
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        <span
                                            class="text-xs text-gray-400 font-mono"><?php echo e($rec->record_date->format('d/m/Y')); ?></span>
                                        <p class="text-xs text-gray-400 mt-0.5">Dr. <?php echo e($rec->doctor->user->name); ?></p>
                                    </div>
                                    <a href="<?php echo e(route('medical-records.show', $rec)); ?>"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p class="text-gray-700 line-clamp-2"><?php echo e($rec->chief_complaint); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-400 mb-0.5">Diagnóstico</p>
                                        <p class="text-gray-900 font-medium line-clamp-2"><?php echo e($rec->diagnosis); ?></p>
                                    </div>
                                </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->prescriptions): ?>
                                    <div class="mt-3 pt-3 border-t border-gray-50 flex items-start gap-2">
                                        ...
                                        <p class="text-xs text-gray-500 line-clamp-1"><?php echo e($rec->prescriptions); ?></p>
                                    </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rec->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('medical-records.attachments.download', $attachment)); ?>" 
                                                   ...
                                                   title="Descargar <?php echo e($attachment->file_name); ?>">
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <span class="max-w-[120px] truncate"><?php echo e($attachment->file_name); ?></span>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->is_private): ?>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\medical-records\patient-history.blade.php ENDPATH**/ ?>