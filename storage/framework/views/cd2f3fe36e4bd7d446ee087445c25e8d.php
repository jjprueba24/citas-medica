...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            ...
            Editar Consultorio — Dr. <?php echo e($doctor->user->name); ?>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form action="<?php echo e(route('doctors.offices.update', [$doctor, $office])); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nombre del Consultorio <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="name" value="<?php echo e(old('name', $office->name)); ?>" required
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text" name="address" value="<?php echo e(old('address', $office->address)); ?>"
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
                </div>
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="floor" value="<?php echo e(old('floor', $office->floor)); ?>"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Teléfono Directo</label>
                        <input type="text" name="phone" value="<?php echo e(old('phone', $office->phone)); ?>"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="url" name="maps_url" value="<?php echo e(old('maps_url', $office->maps_url)); ?>"
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="pt-2 pb-4">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $office->is_active) ? 'checked' : ''); ?> class="w-5 h-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500">
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\doctors\offices\edit.blade.php ENDPATH**/ ?>