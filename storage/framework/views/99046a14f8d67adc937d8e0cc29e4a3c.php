...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mi Historial Médico <?php $__env->endSlot(); ?>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <?php else: ?>
            <div class="relative">
                ...
                <div class="space-y-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6 hover:shadow-md hover:-translate-y-0.5 transition duration-200">
                                <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-4">
                                    <div class="flex items-start gap-4">
                                        <div class="w-12 h-12 shrink-0 rounded-xl bg-blue-50 text-blue-600 flex flex-col items-center justify-center font-bold sm:hidden">
                                            <span class="text-lg leading-none"><?php echo e($rec->record_date->format('d')); ?></span>
                                            <span class="text-[10px] uppercase font-semibold"><?php echo e($rec->record_date->translatedFormat('M')); ?></span>
                                        </div>
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900 flex items-center gap-2">
                                                Dr. <?php echo e($rec->doctor->user->name); ?>

                                                <span class="hidden sm:inline-block w-1 h-1 rounded-full bg-gray-300"></span>
                                                <span class="hidden sm:inline text-gray-500 font-normal"><?php echo e($rec->doctor->specialties->first()->name ?? 'Medicina General'); ?></span>
                                            </p>
                                            <p class="text-xs text-gray-400 mt-1 sm:hidden"><?php echo e($rec->doctor->specialties->first()->name ?? 'Medicina General'); ?></p>
                                            <p class="text-xs font-mono text-gray-400 mt-1.5 sm:hidden"><?php echo e($rec->record_date->format('d/m/Y')); ?></p>
                                        </div>
                                    </div>
                                    <div class="hidden sm:block text-right">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-gray-50 text-gray-600 border border-gray-200 shadow-sm">
                                            ...
                                            <?php echo e($rec->record_date->format('d / m / Y')); ?>
                                ...
                                <div class="box-border border border-gray-100 bg-gray-50/50 rounded-xl p-4 sm:p-5 mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <p class="text-gray-700 leading-relaxed"><?php echo e($rec->chief_complaint); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Diagnóstico</p>
                                        <p class="text-gray-900 font-medium leading-relaxed"><?php echo e($rec->diagnosis); ?></p>
                                    </div>
                                </div>

                                <div class="space-y-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->treatment): ?>
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 leading-relaxed pl-5.5"><?php echo e($rec->treatment); ?></p>
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->prescriptions): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->attachments && $rec->attachments->count() > 0): ?>
                                    <div class="mt-4 pt-4 border-t border-gray-100">
                                        <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Archivos Adjuntos</h4>
                                        <div class="flex flex-wrap gap-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rec->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('medical-records.attachments.download', $attachment)); ?>" 
                                                   ...
                                                   title="Descargar <?php echo e($attachment->file_name); ?>">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array(strtolower(pathinfo($attachment->file_name, PATHINFO_EXTENSION)), ['jpg','jpeg','png'])): ?>
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <span class="max-w-[150px] truncate"><?php echo e($attachment->file_name); ?></span>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->blood_pressure || $rec->weight || $rec->height): ?>
                                    <div class="mt-4 pt-3 border-t border-gray-100 flex flex-wrap gap-x-4 gap-y-2 text-xs text-gray-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->blood_pressure): ?><span><strong>PA:</strong> <?php echo e($rec->blood_pressure); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->heart_rate): ?><span><strong>FC:</strong> <?php echo e($rec->heart_rate); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->weight): ?><span><strong>Peso:</strong> <?php echo e($rec->weight); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rec->height): ?><span><strong>Talla:</strong> <?php echo e($rec->height); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\portal\medical-history.blade.php ENDPATH**/ ?>