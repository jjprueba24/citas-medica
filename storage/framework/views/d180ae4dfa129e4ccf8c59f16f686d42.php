...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Nueva Receta Médica <?php $__env->endSlot(); ?>

    <div class="max-w-4xl mx-auto">
        <form method="POST" action="<?php echo e(route('prescriptions.store')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="patient_id" required
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($patient->id); ?>" <?php echo e(old('patient_id', $selectedPatient) == $patient->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select name="doctor_id" required
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($doctor->id); ?>" <?php echo e(old('doctor_id', $selectedDoctor) == $doctor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Fecha <span
                                class="text-red-500">*</span></label>
                        <input type="date" name="date" value="<?php echo e(old('date', now()->format('Y-m-d'))); ?>" required
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mt-5">
                    ...
                    <textarea name="notes" rows="2" placeholder="Recomendaciones generales, dieta, reposo..."
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:ring-2 focus:ring-blue-400"><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\prescriptions\create.blade.php ENDPATH**/ ?>