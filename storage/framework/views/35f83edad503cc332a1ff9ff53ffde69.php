...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('doctors.show', $doctor)); ?>" class="text-gray-400 hover:text-blue-500 transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
            </a>
            Consultorios — Dr. <?php echo e($doctor->user->name); ?>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('doctors.offices.create', $doctor)); ?>"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $offices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $office): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div
                class="bg-white rounded-2xl shadow-sm border <?php echo e($office->is_active ? 'border-gray-100' : 'border-gray-200 bg-gray-50'); ?> p-6 relative group transition hover:shadow-md">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-1 <?php echo e(!$office->is_active ? 'text-gray-500' : ''); ?>">
                    <?php echo e($office->name); ?></h3>
                ...
                <div class="space-y-2 text-sm text-gray-500 mt-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->address): ?>
                        <p class="flex items-start gap-2">
                            ...
                            <span><?php echo e($office->address); ?> <?php echo e($office->floor ? "({$office->floor})" : ''); ?></span>
                        </p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($office->maps_url): ?>
                        <p class="flex items-center gap-2">
                            <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                            </svg>
                            <a href="<?php echo e($office->maps_url); ?>" target="_blank"
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex gap-2">
                    <a href="<?php echo e(route('doctors.offices.edit', [$doctor, $office])); ?>"
                    ...
                    <form action="<?php echo e(route('doctors.offices.destroy', [$doctor, $office])); ?>" method="POST" class="flex-1"
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\doctors\offices\index.blade.php ENDPATH**/ ?>