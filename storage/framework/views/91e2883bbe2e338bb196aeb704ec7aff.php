...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Editar Aseguradora <?php $__env->endSlot(); ?>

    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form method="POST" action="<?php echo e(route('insurances.update', $insurance)); ?>" class="space-y-6">
                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nombre de ARS o Seguro <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="name" value="<?php echo e(old('name', $insurance->name)); ?>" required
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="rnc_or_code" value="<?php echo e(old('rnc_or_code', $insurance->rnc_or_code)); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="coverage_percentage"
                            value="<?php echo e(old('coverage_percentage', $insurance->coverage_percentage)); ?>" required
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="contact_phone"
                            value="<?php echo e(old('contact_phone', $insurance->contact_phone)); ?>"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Email de Contacto</label>
                        <input type="email" name="contact_email"
                            value="<?php echo e(old('contact_email', $insurance->contact_email)); ?>"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\insurances\edit.blade.php ENDPATH**/ ?>