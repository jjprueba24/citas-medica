...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex items-center gap-5">
            <img src="<?php echo e($photo ? $photo->temporaryUrl() : Auth::user()->avatar_url); ?>"
                ...
                <div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-green-600">
                            <?php echo e(__('Se envió un nuevo enlace a tu email.')); ?>
...
</section><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\livewire\profile\update-profile-information-form.blade.php ENDPATH**/ ?>