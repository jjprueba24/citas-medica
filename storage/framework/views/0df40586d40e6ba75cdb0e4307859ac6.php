...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <form action="<?php echo e(route('settings.backups.create')); ?>" method="POST"
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-gray-600"><?php echo e($backup['size']); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($backup['date']); ?></td>
                            <td class="px-6 py-4 text-right">
                                <form action="<?php echo e(route('settings.backups.download')); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="path" value="<?php echo e($backup['path']); ?>">
                                    <button type="submit"
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views/settings/backups.blade.php ENDPATH**/ ?>