...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Editar Tipo de Cita - Dr. <?php echo e($doctor->user->name); ?> <?php $__env->endSlot(); ?>

    <div class="max-w-2xl mx-auto">
        <form action="<?php echo e(route('doctors.appointment-types.update', [$doctor, $appointmentType])); ?>" method="POST"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $appointmentType->name)); ?>" required
                ...
                <div>
                    ...
                    <select name="duration_minutes" required
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [10, 15, 20, 30, 40, 45, 60, 90, 120]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $min): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($min); ?>" <?php echo e(old('duration_minutes', $appointmentType->duration_minutes) == $min ? 'selected' : ''); ?>><?php echo e($min); ?> minutos</option>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" name="price"
                            value="<?php echo e(old('price', $appointmentType->price)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="md:col-span-2 flex items-center gap-3">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e(old('is_active', $appointmentType->is_active) ? 'checked' : ''); ?>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\doctors\appointment-types\edit.blade.php ENDPATH**/ ?>