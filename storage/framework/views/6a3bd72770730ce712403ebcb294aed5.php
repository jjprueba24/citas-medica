...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Mis Recibos <?php $__env->endSlot(); ?>
                        ...
                        <div
                                ...
                                <div class="pt-1">
                                    <div class="flex flex-wrap items-center gap-3 mb-1.5">
                                        <h3 class="font-bold text-gray-900 text-lg tracking-tight">Consulta Dr.
                                            <?php echo e($invoice->appointment->doctor->user->name ?? 'N/A'); ?>
                                    ...
                                    <div
                                        ...
                                        <span>Cita del
                                            <?php echo e(\Carbon\Carbon::parse($invoice->appointment->date)->format('d/m/Y')); ?></span>
                                    </div>
                                    <div
                                        ...
                                        Factura No: <?php echo e(str_pad($invoice->id, 5, '0', STR_PAD_LEFT)); ?> | Emitida:
                                        <?php echo e(\Carbon\Carbon::parse($invoice->created_at)->format('d/m/Y')); ?>
                            ...
                            <div
                                ...
                                <div class="text-left sm:text-right">
                                    ...
                                    <span
                                        class="text-2xl font-extrabold tracking-tight <?php echo e($invoice->status === 'paid' ? 'text-gray-900' : 'text-gray-500'); ?>">
                                        <?php echo e(\App\Models\Setting::get('currency_symbol', '$')); ?><?php echo e(number_format($invoice->amount, 2)); ?>
                                ...
                                <div class="flex items-center gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->status === 'pending'): ?>
                                        <form action="<?php echo e(route('portal.invoices.checkout', $invoice)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                                    ...
                                    <a href="<?php echo e(route('invoices.pdf', $invoice)); ?>" target="_blank"
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\portal\invoices.blade.php ENDPATH**/ ?>