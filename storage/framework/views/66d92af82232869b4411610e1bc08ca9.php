<aside
    ...
    <div class="h-20 flex items-center justify-center border-b border-white/20 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <span class="text-xs font-bold tracking-wider hidden lg:block"><?php echo e($clinicName); ?></span>
        </div>
    </div>
    ...
    <nav class="flex-1 py-6 space-y-1">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route($item['route'])); ?>"
                class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e($active ? 'text-white' : 'text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-gray-100'); ?> transition">
                ...
                <span class="hidden lg:block font-medium text-sm"><?php echo e($item['label']); ?></span>
            </a>
    ...
    <div class="pb-6 space-y-1">
        ...
        <a href="<?php echo e(route('users.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('users.*') ? 'text-white' : 'text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-gray-100'); ?> transition">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('users.*')): ?>
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-white rounded-r-md"></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-5 h-5 lg:mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo e(route('settings.backups.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.backups.*') ? 'text-white' : 'text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-gray-100'); ?> transition">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('settings.backups.*')): ?>
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-white rounded-r-md"></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <a href="<?php echo e(route('settings.email_templates.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.email_templates.*') ? 'text-white' : 'text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-gray-100'); ?> transition">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('settings.email_templates.*')): ?>
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-white rounded-r-md"></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-5 h-5 lg:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo e(route('settings.index')); ?>"
            class="flex items-center justify-center lg:justify-start lg:px-6 py-3 relative <?php echo e(request()->routeIs('settings.index') ? 'text-white' : 'text-white/70 hover:text-white dark:text-gray-400 dark:hover:text-gray-100'); ?> transition">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->routeIs('settings.index')): ?>
                <div class="absolute left-0 top-0 bottom-0 w-1 bg-white rounded-r-md"></div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <svg class="w-5 h-5 lg:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
</aside><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views/components/sidebar.blade.php ENDPATH**/ ?>