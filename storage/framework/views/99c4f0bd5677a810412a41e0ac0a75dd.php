...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Calendario de Citas <?php $__env->endSlot(); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <select id="filter-doctor"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($doc->id); ?>">Dr. <?php echo e($doc->user->name); ?></option>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="w-3 h-3 rounded-full flex-shrink-0" style="background:<?php echo e($item['color']); ?>"></span>
                        <span class="text-xs text-gray-600"><?php echo e($item['label']); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        calendar = new FullCalendar.Calendar(calEl, {
            ...
            dateClick: function(info) {
                window.location.href = '<?php echo e(route("appointments.create")); ?>?date=' + info.dateStr + 'T08:00';
            },
...
<?php endif; ?>
<?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\appointments\calendar.blade.php ENDPATH**/ ?>