...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Editar Plantilla de Diagnóstico <?php $__env->endSlot(); ?>

    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form method="POST" action="<?php echo e(route('diagnostic-templates.update', $diagnosticTemplate)); ?>"
                class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $diagnosticTemplate->name)); ?>" required
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="mb-2 relative">
                    ...
                    <input type="text" id="icd10_search" placeholder="Escriba para buscar enfermedad o código..."
                        value="<?php echo e(old('icd_code', $diagnosticTemplate->icd_code)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('diagnosis_text', $diagnosticTemplate->diagnosis_text)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea name="treatment_text" rows="3"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('treatment_text', $diagnosticTemplate->treatment_text)); ?></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Prescripciones</label>
                        <textarea name="prescriptions_text" rows="3"
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('prescriptions_text', $diagnosticTemplate->prescriptions_text)); ?></textarea>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="notes_text" rows="3"
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('notes_text', $diagnosticTemplate->notes_text)); ?></textarea>
                </div>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\diagnostic-templates\edit.blade.php ENDPATH**/ ?>