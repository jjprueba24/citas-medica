...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> Editar Médico: <?php echo e($doctor->user->name); ?> <?php $__env->endSlot(); ?>

    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            <form method="POST" action="<?php echo e(route('doctors.update', $doctor)); ?>" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $doctor->user->name)); ?>" required
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Correo electrónico <span
                                class="text-red-500">*</span></label>
                        <input type="email" name="email" value="<?php echo e(old('email', $doctor->user->email)); ?>" required
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <select name="specialty_id" required
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sp->id); ?>" <?php echo e((old('specialty_id', $doctor->specialty_id) == $sp->id) ? 'selected' : ''); ?>><?php echo e($sp->name); ?></option>
                    ...
                    <div>
                        ...
                        <input type="text" name="collegiate_number"
                            value="<?php echo e(old('collegiate_number', $doctor->collegiate_number)); ?>" required
                            class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="biography" rows="3"
                        class="w-full rounded-lg border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(old('biography', $doctor->biography)); ?></textarea>
                </div>
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\doctors\edit.blade.php ENDPATH**/ ?>