    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                ...
                <p class="text-3xl font-bold text-gray-800 mt-1"><?php echo e($stats['total']); ?></p>
            </div>
            <div class="bg-green-50 rounded-2xl border border-green-100 shadow-sm p-5">
                ...
                <p class="text-3xl font-bold text-green-700 mt-1"><?php echo e($stats['paid']); ?></p>
            </div>
            <div class="bg-yellow-50 rounded-2xl border border-yellow-100 shadow-sm p-5">
                ...
                <p class="text-3xl font-bold text-yellow-700 mt-1"><?php echo e($stats['pending']); ?></p>
            </div>
            <div class="bg-blue-50 rounded-2xl border border-blue-100 shadow-sm p-5">
                ...
                <p class="text-2xl font-bold text-blue-700 mt-1"><?php echo e(\App\Models\Setting::get('currency_symbol', 'S/')); ?>

                    <?php echo e(number_format($stats['revenue'], 2)); ?></p>
            </div>
        </div>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50/50 transition">
                                    <td class="px-6 py-4 text-gray-400 font-mono"><?php echo e($invoice->id); ?></td>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="<?php echo e(route('invoices.show', $invoice)); ?>" title="Ver"
                                            ...
                                            <a href="<?php echo e(route('invoices.edit', $invoice)); ?>" title="Editar"
                                            ...
                                            <a href="<?php echo e(route('invoices.pdf', $invoice)); ?>" title="Descargar PDF"
...
<?php endif; ?><?php /**PATH C:\Webs\PHP\citasmedicas\resources\views\invoices\index.blade.php ENDPATH**/ ?>